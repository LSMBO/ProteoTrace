...
if (args.r and args.f):
    ...
    output_file_pkl = os.path.join(args.tmp_path, f"Maxquant_proteotrace_{random_suffix}.pkl")
    output_file_txt = os.path.join(args.tmp_path, f"Maxquant_proteotrace_protein_list_{random_suffix}.txt")
    ...
    pkl_file = os.path.join(args.tmp_path, f"Maxquant_proteotrace_{args.runID}.pkl")
